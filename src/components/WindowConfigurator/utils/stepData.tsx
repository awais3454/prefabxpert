  ...
  switch (currentStep) {
      ...
      return {
        ...
        content: (
          <div className="space-y-4">
            <p className="text-[17px] text-white leading-relaxed font-bold">
          ...
          <div className="space-y-4 text-white font-medium">
            ...
            <ul className="space-y-2">
              <li className="text-[17px] leading-relaxed flex items-start gap-2">
                ...
                <span>
                  <span className="font-extrabold text-white">Digitale waterpas:</span> Houd deze tegen het dakbeschot aan de binnenkant van het dak en lees de graden af.
                </span>
              </li>
              <li className="text-[17px] leading-relaxed flex items-start gap-2">
                <div className="h-1.5 w-1.5 rounded-full bg-white/60 mt-2.5 flex-shrink-0" />
                <span>
                  <span className="font-extrabold text-white">Smartphone app:</span> Download een gratis hellingmeter app via de <a href="https://apps.apple.com/nl/app/waterpas-en-hellingmeter-app/id1672836817" target="_blank" rel="noopener noreferrer" className="underline decoration-white font-extrabold text-white cursor-pointer">App Store</a> of <a href="https://play.google.com/store/apps/details?id=com.syleosapps.inclinometer&hl=nl&gl=US&pli=1" target="_blank" rel="noopener noreferrer" className="underline decoration-white font-extrabold text-white cursor-pointer">Google Play</a> en meet de hoek eenvoudig.
                </span>
              </li>
            </ul>
          </div>
    ...
    case 3:
      return {
        ...
        content: (
          <div className="space-y-4 text-white font-medium pt-0">
            <div className="space-y-2">
              <p className="text-[17px] leading-relaxed">
                <span className="font-extrabold text-white">Hoogte bepalen:</span> De totale hoogte van een dakkapel is de afstand van de vloer tot de bovenkant van de dakkapel. Die bestaat uit:
              </p>
            ...
            <p className="text-[17px] leading-relaxed">
              <span className="font-extrabold text-white">Vergunningsplicht:</span> Een dakkapel van 1,75 m of lager valt meestal buiten vergunningsplicht (mits hij ook aan andere voorwaarden voldoet). Bij meer dan 1,75 m is wél een vergunning nodig.
            </p>

            <p className="text-[17px] leading-relaxed">
              <span className="font-extrabold text-white">Borstwering:</span> Een borstwering is een extra dicht paneel onder het raam, voor wie het kozijn hoger wil plaatsen. Dit element wordt vaak gebruikt om meer loopruimte te creëren.
            </p>
          </div>
        )
      };
    ...
    case 5:
      return {
        ...
        content: (
          <div className="space-y-3 text-white font-medium pb-2">
            <p className="text-[15px] leading-relaxed">
            ...
            <ul className="space-y-2">
              <li className="text-[15px] leading-relaxed flex items-start gap-2 pl-4">
                ...
                <span><span className="font-bold text-white">Selecteer een kozijn:</span> Gebruik de pijltjes of klik op een kozijn om het te selecteren.</span>
              </li>
              <li className="text-[15px] leading-relaxed flex items-start gap-2 pl-4">
                <div className="h-1.5 w-1.5 rounded-full bg-white/60 mt-2 flex-shrink-0" />
                <span><span className="font-bold text-white">Camera zoomt in:</span> De camera zoomt automatisch in op het geselecteerde kozijn.</span>
              </li>
              <li className="text-[15px] leading-relaxed flex items-start gap-2 pl-4">
                <div className="h-1.5 w-1.5 rounded-full bg-white/60 mt-2 flex-shrink-0" />
                <span><span className="font-bold text-white">Stel de breedte in:</span> Gebruik de slider of de +/- knoppen om de breedte aan te passen.</span>
              </li>
            </ul>
            <p className="text-[15px] leading-relaxed">
        ...
        content: (
          <div className="space-y-3 text-white font-medium pb-2">
            ...
            <ul className="space-y-2">
              <li className="text-[15px] leading-relaxed flex items-start gap-2 pl-4">
                <div className="h-1.5 w-1.5 rounded-full bg-white/60 mt-2 flex-shrink-0" />
                <span><span className="font-bold text-white">Kozijnbreedte:</span> De breedte van elk kozijn die u in de vorige stap heeft ingesteld.</span>
              </li>
              <li className="text-[15px] leading-relaxed flex items-start gap-2 pl-4">
                <div className="h-1.5 w-1.5 rounded-full bg-white/60 mt-2 flex-shrink-0" />
                <span><span className="font-bold text-white">Penanten:</span> De tussenwanden tussen de kozijnen. De breedte hiervan kunt u hier aanpassen.</span>
              </li>
              <li className="text-[15px] leading-relaxed flex items-start gap-2 pl-4">
                <div className="h-1.5 w-1.5 rounded-full bg-white/60 mt-2 flex-shrink-0" />
                <span><span className="font-bold text-white">Zijwangen:</span> Aan beide zijkanten van de dakkapel plaatsen wij standaard een vaste zijwang van 16 cm, met een afwerkbalk van 4,4 cm.</span>
              </li>
            </ul>
            <p className="text-[15px] leading-relaxed">
    ...
    case 7:
      return {
        ...
        content: (
          <div className="space-y-4 text-white font-medium pb-2">
            <p className="text-[15px] leading-relaxed">
    ...
    case 8:
      return {
        ...
        content: (
          <div className="space-y-4 text-white font-medium pb-2">
            <p className="text-[15px] leading-relaxed">
              <span className="font-extrabold text-white">Dakbedekking:</span> Kies tussen bitumen of EPDM als afwerking van het platte dak van de dakkapel. Beide zijn waterdicht en duurzaam.
            </p>
            <p className="text-[15px] leading-relaxed">
              <span className="font-extrabold text-white">Aansluiting pannendak:</span> De aansluiting op uw bestaande pannendak kan met lood of met een loodvervanger worden uitgevoerd.
            </p>
          </div>
        )
      };
      ...
      return {
        ...
        content: (
          <div className="space-y-4 text-white font-medium pb-2">
            ...
            <p className="text-[15px] leading-relaxed font-bold text-white">
    ...
    case 10:
      return {
        ...
        content: (
          <div className="space-y-2 text-white font-medium pb-2">
            <p className="text-[17px] leading-relaxed">
            ...
            <p className="text-[17px] leading-relaxed font-bold text-white">
