...
function Stepper({
  ...
  return (
    <div className="flex items-center justify-between mb-2">
      <span className={`text-[17px] tracking-tighter ${bold ? 'font-black text-[#6E94B0]' : 'font-semibold text-[#4A7593]'}`}>
        {label}
      </span>
...
export function Step5Width({ config, onChange }: StepProps) {
  ...
  return (
    <div className="flex flex-col flex-1 px-10 pt-2 pb-4 text-left animate-in fade-in slide-in-from-bottom-4 duration-500 step-5-width-container overflow-y-auto">
      ...
      {/* 2x zijwang */}
      <div className="flex items-center justify-between mb-2">
        <span className="text-[17px] font-normal text-[#5E84A0] tracking-tight">2x zijwang</span>
        <div className="flex items-center gap-8">
      ...
      {/* Totaal */}
      <div className="flex items-center justify-between mt-1 pt-1 border-t border-[#6E94B0]/25">
        <span className="text-[17px] font-black text-[#6E94B0] tracking-tighter">Totaal</span>
        <div className="flex items-center gap-8">
          <div className="w-[42px]" />
          <div className="text-[16px] font-black text-[#6E94B0] min-w-[70px] text-center select-none tracking-tighter">
